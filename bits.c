...
int leftBitCount(int x)
{
    ...
    Example 1
    ----------------------------------------------------------
    temp           | 1111 1111 1111 1111 1111 1111 1101 0011
    temp>>16       | 1111 1111 1111 1111 1111 1111 1111 1111
    ~(temp>>16)    | 0000 0000 0000 0000 0000 0000 0000 0000
    !(~(temp>>16)) | 1
    result         | 10000
    temp           | 1111 1111 1101 0011 0000 0000 0000 0000

    Example 2
    ----------------------------------------------------------
    temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    temp>>16       | 1111 1111 1111 1111 1110 1111 1100 1111
    ~(temp>>16)    | 0000 0000 0000 0000 0001 0000 0011 0000
    !(~(temp>>16)) | 0
    result         | 00000
    temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    ...
    // ----------------------------------------------------------
    // temp           | 1111 1111 1101 0011 0000 0000 0000 0000
    // temp>>24       | 1111 1111 1111 1111 1111 1111 1111 1111
    // ~(temp>>24)    | 0000 0000 0000 0000 0000 0000 0000 0000
    // !(~(temp>>24)) | 1
    // shift          | 01000
    // result         | 11000
    // temp           | 1101 0011 0000 0000 0000 0000 0000 0000
    //
    // Example 2
    // ----------------------------------------------------------
    // temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    // temp>>24       | 1111 1111 1111 1111 1111 1111 1110 1111
    // ~(temp>>24)    | 0000 0000 0000 0000 0000 0000 0001 0000
    // !(~(temp>>24)) | 0
    // shift          | 00000
    // result         | 00000
    // temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    ...
    // ----------------------------------------------------------
    // temp           | 1101 0011 0000 0000 0000 0000 0000 0000
    // temp>>28       | 1111 1111 1111 1111 1111 1111 1111 1101
    // ~(temp>>28)    | 0000 0000 0000 0000 0000 0000 0000 0010
    // !(~(temp>>28)) | 0
    // shift          | 00000
    // result         | 11000
    // temp           | 1101 0011 0000 0000 0000 0000 0000 0000
    ...
    // ----------------------------------------------------------
    // temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    // temp>>28       | 1111 1111 1111 1111 1111 1111 1111 1110
    // ~(temp>>28)    | 0000 0000 0000 0000 0000 0000 0000 0001
    // !(~(temp>>28)) | 0
    // shift          | 00000
    // result         | 00000
    // temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    ...
    // ----------------------------------------------------------
    // temp           | 1101 0011 0000 0000 0000 0000 0000 0000
    // temp>>30       | 1111 1111 1111 1111 1111 1111 1111 1111
    // ~(temp>>30)    | 0000 0000 0000 0000 0000 0000 0000 0000
    // !(~(temp>>30)) | 1
    // shift          | 00010
    // result         | 11010
    // temp           | 0100 1100 0000 0000 0000 0000 0000 0000
    //
    // Example 2
    // ----------------------------------------------------------
    // temp           | 1110 1111 1100 1111 1100 0100 1101 0011
    ...
    // shift          | 00010
    // result         | 00010
    // temp           | 1011 1111 0011 1111 0001 0011 0100 1100
    //
	shift = !(~(temp >> 30)) << 1;
	result = result | shift;
	temp = temp << shift;
    ...
    // ----------------------------------------------------------
    // temp           | 0100 1100 0000 0000 0000 0000 0000 0000
    // temp>>31       | 0000 0000 0000 0000 0000 0000 0000 0000
    // ~(temp>>31)    | 1111 1111 1111 1111 1111 1111 1111 1111
    // !(~(temp>>31)) | 0
    // shift          | 00000
    // result         | 11010
    //
